...
void DialplateView::TopInfo_Create(lv_obj_t* parent)
{
    ...
    lv_obj_align_to(label, ui.topInfo.labelSpeed, LV_ALIGN_OUT_BOTTOM_MID, 0, 2);
...
void DialplateView::BottomInfo_Create(lv_obj_t* parent)
{
    ...
    lv_obj_align(cont, LV_ALIGN_TOP_MID, 0, 175);
...
void DialplateView::BtnCont_Create(lv_obj_t* parent)
{
    ...
    lv_obj_align_to(cont, ui.bottomInfo.cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 40);
