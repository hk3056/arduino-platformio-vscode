...
void Dialplate::Update()
{
    ...
    char avg_buf[32];
    snprintf(avg_buf, sizeof(avg_buf), "%.1f km/h", Model.GetAvgSpeed());
    lv_label_set_text(View.ui.bottomInfo.labelInfoGrp[0].lableValue, avg_buf);
    ...
    char trip_buf[32];
    snprintf(trip_buf, sizeof(trip_buf), "%.1f km", Model.sportStatusInfo.singleDistance / 1000.0f);
    lv_label_set_text(View.ui.bottomInfo.labelInfoGrp[2].lableValue, trip_buf);
    ...
    if (obj == instance->View.ui.btnCont.btnRec)
    {
        if (code == LV_EVENT_SHORT_CLICKED)
        {
            ...
            case RECORD_STATE_READY:
                ...
                // 无论 GPS 是否 ready，都先进入 RideData 页面
